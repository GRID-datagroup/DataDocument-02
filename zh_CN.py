...
"""
    sphinx.search.zh_CN
    ~~~~~~~~~~~~~~~~
    Chinese Simplified search language: includes routine to split words.
    :copyright: Copyright 2014 by bosbyj.
...
class SearchChinese(SearchLanguage):
    ...
    def split(self, input):
        ...
        languages.
        "Jieba" splits words with latin1 letters apart, eg. Naïve -> Na,ï,ve
        thus we need to find all latin1 words by ourselves...
        """
        chinese = list(jieba.cut_for_search(input))
        latin1 = self._latin1_re.findall(input)
